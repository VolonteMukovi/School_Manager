...
<head>
    ...
    <title>periode_professeur - School Manager</title>
...
<div class="h-screen flex overflow-hidden bg-gray-200">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="p-6">
                <a href="consulter_travaux.php">
                    <div class="bg-white p-4 rounded shadow-md mb-6 cursor-pointer">
                        <h2 class="text-xl font-semibold mb-4">1ère Période</h2>
                    </div>
                </a>
