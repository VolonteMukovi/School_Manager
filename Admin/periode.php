            ...
            <main class="p-6">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white shadow-md rounded-lg">
                        ...
                        <tbody>
                            <?php $periode = affichePeriode($db);
                            foreach ($periode as $periodes) {
                                
                            ?>
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-4 text-center"> <?php echo $periodes->periode   ?></td>
                                    <td class="py-3 px-4 text-center">
                                        <a href="ajout_periode.php?action=editer&epreuve=<?php echo $periodes->id_periode ?>" class="text-blue-500 hover:text-blue-700 mr-2">
                                            <i class="fas fa-edit text-center"></i> Éditer
                                        </a>
                                        <a href="suppression.php?action=suppression&periode=<?php echo $periodes->id_periode   ?>" class="text-red-500 hover:text-red-700 mr-2">
