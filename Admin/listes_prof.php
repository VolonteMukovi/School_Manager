                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left">
                                    <img src="assets/system-administrator-4487123-3726273.webp" alt="Photo Prof" class="w-10 h-10 rounded-full">
                                </td>
                                <td class="py-3 px-6 text-center">12345</td>
                                <td class="py-3 px-6 text-center">exo</td>
                                <td class="py-3 px-6 text-center">war</td>
                                <td class="py-3 px-6 text-center">A1</td>
                                <td class="py-3 px-6 text-center">$2000</td>
                                <td class="py-3 px-6 text-center">+243 123 456 789</td>
                                <td class="py-3 px-6 text-center">kahumo</td>
