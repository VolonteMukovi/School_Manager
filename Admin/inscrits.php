...
<body class="bg-gray-100 min-h-screen">
    <div class="flex">
        <?php include "sidebar.php"; ?>
          <!-- action=consulter&annee15&status=Cloturer -->
        <div class="flex-grow ">
            <?php include "header.php";

            if (isset($_GET["annee"]) and isset($_GET["status"]) and $_GET["status"] == "Cloturer") {
                if (isset($_GET["action"]) and $_GET["action"] == "consulter") { ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white shadow-md rounded ">
                            ...
                            <tbody>
                                <?php $affEleve = AfficheAnneePasserEleve($db,$_GET["annee"],$_GET["status"]);
