                        ...
                        foreach ($affEleve as $eleve) { ?>
                            <tr>
                                ...
                                <td class="border-t py-2 px-4 text-center">
                                    ...
                                    <button class="text-red-500 hover:text-red-700 ml-2"><i class="fas fa-trash"></i><a href="ajouts_eleves.php?action=supprimer&eleve=<?php echo  $eleve->ID_eleve ?>">Supprimer</a> </button>
