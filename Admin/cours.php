                        ...
                        <tbody>
                            ...
                            foreach ($affCours as $cour) {  ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border-t"><?php echo $cour->designation_cours  ?></td>
                                    ...
                                    <td class="px-4 py-2 border-t"><?php echo $cour->designation_classes . "  " . $cour->designation_option  ?></td>
                                    <td class="px-4 py-2 border-t">
                                        <div class="flex space-x-2">
                                            
                                            <a href="ajouter_cours.php?action=edit&cour=<?php echo $cour->ID_cours ?>" class="text-blue-500 hover:text-blue-700">
