...
<head>
    ...
    <title>Se connecter en tant que comptable - School Manager</title>
...
<body class="bg-[#16C8FF] min-h-screen flex flex-col items-center justify-center">
    ...
    <main class="flex flex-col md:flex-row items-center bg-white shadow-lg rounded-lg p-6 w-full md:w-2/3 lg:w-1/2 mt-24">
        <div class="hidden md:block md:w-1/2 mr-4">
            <img src="22241906-comptable-employe-a-travail-financier-directeur-a-ordinateur-bureau-femme-d-affaires-bureau-ouvrier-avec-la-finance-et-comptabilite-documents-poster-plat-vecteur-moderne-illustration-vectoriel.jpg" alt="Illustration Admin" class="rounded-lg">
        </div>

        <div class="w-full md:w-1/2">
            <h2 class="text-xl font-bold text-center mb-6">Se connecter en tant que comptable</h2>
